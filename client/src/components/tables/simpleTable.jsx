...
const SimpleTableComponent = ({ columns, data, isPagination }) => {
  ...
  return (
    <Flex w='full' flexDirection='column' gap='4'>
      ...
      {page.length === 0 ? (
        <Flex w='100%' fontSize={18} color='brand.black' fontWeight='medium'>
          No data available
        </Flex>
      ) : (
        <TableContainer
          ...
          p='2'
        >
          <Table w='100%' variant='simple' {...getTableProps()} size='sm'>
            <Thead>
